  ...
  return (
    ...
    >
      <style>{`
        ...
        .news-track { display:inline-flex; gap:1.75rem; white-space:nowrap; animation: marquee 18s linear infinite; }
        .news-track:hover { animation-play-state: paused; }
        .news-item { display:inline-flex; align-items:center; gap:0.5rem; max-width:72vw; overflow:hidden; }
        ...
        @media (max-width: 640px) {
          ...
          .news-item { max-width:82vw; font-size:12px; }
            ...
            <div className="overflow-hidden">
              <div className="news-track">
                {[...items, ...items].map((it, idx) => (
                  <span key={idx} className="news-item text-sm font-medium text-white/95">
